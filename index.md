...
PeakPilot ("we", "our", or "us") is committed to protecting your personal information. This Privacy Policy explains how we collect, use, store, and share information when you use the PeakPilot mobile application and related services (collectively, the "Service").

By using PeakPilot you agree to the practices described in this policy. If you do not agree, please do not use the Service.
...
- All account data is stored in a secure database hosted on our servers.
...
We may update this Privacy Policy from time to time. When we do, we will update the "Last updated" date at the top and, for material changes, notify you via the app or by email.
